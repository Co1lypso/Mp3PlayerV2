...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] tracks = new int[]{R.raw.track1, R.raw.track2, R.raw.track3, R.raw.track4, R.raw.track5};
        int[] thumbnails = new int[]{R.drawable.track1, R.drawable.track2, R.drawable.track3, R.drawable.track4, R.drawable.track5};
        String[] trackNames = new String[]{"Rammstein - SONNE", "$uicideboy$ - ANTARCTICA", "Eminem - SUPERMAN", "The Weeknd - SAVE YOUR TEARS", "Bones - HDMI"};
